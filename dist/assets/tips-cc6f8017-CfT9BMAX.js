import{c as e,t}from"./index-B7fxLJ5C.js";import{t as n}from"./jsx-utils-b7f01bf6-DS6fS2Rm.js";var r=(t,n)=>[e(`div`,{class:`text-on-background flex h-full w-full flex-col items-center`},n),e(`slot`,null)],i=({firstSearchExecuted:n,isLoading:r,hasResults:i},a)=>{if(!(!n||r||i))return e(t,null,a)},a=`<svg viewBox="0 0 312 312" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,o=()=>e(`atomic-icon`,{part:`icon`,icon:a,class:`my-6 flex w-1/2 max-w-lg flex-col items-center`}),s=({i18n:t,query:r})=>{let i=r?e(n,{i18n:t,key:`no-results-for`,params:{query:e(`span`,{class:`inline-block max-w-full truncate whitespace-normal align-bottom font-bold`,part:`highlight`},e(n,{key:`between-quotations`,params:{text:r},i18n:t}))}}):t.t(`no-results`);return e(`div`,{class:`my-2 max-w-full text-center text-2xl font-medium`,part:`no-results`},i)},c=({i18n:t})=>e(`div`,{class:`text-neutral-dark my-2 text-center text-lg`,part:`search-tips`},t.t(`search-tips`));export{c as a,i,s as n,r,o as t};